...
async function create(payload: { resourceId: string; startAt: string; endAt: string }): Promise<void> { const reservation = await reservations.create(payload); createdId.value = reservation.id }
</script>
