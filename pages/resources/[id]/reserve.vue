...
async function create(payload: { resourceId: string; startAt: string; endAt: string }): Promise<void> { await reservations.createHold(payload); const reservation = await reservations.create(payload); createdId.value = reservation.id }
</script>
