...
<template><main class="page-wrap max-w-5xl"><PaymentSimulatedPaymentModal :reservation="reservation" :is-processing="processing" :error-message="error" @simulate="simulate" @close="navigateTo('/reservations')" /></main></template>
